...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "btn_refresh_training_status": "Refresh Training Log",
        ...
        "sample_auto_started": "Auto Sample for epoch {epoch} started: {path}",
        "sample_training_active": "Training is still running; Sample can still be queued, but it may fail if VRAM is not enough.",
        ...
        "training_status_active": "Training is running in this UI process. PID: {pid}",
        "training_status_thread_active": "Training worker is active. Status: {status}",
        "training_status_detached": "A previously started training process may still be running. PID: {pid}",
        "training_status_last": "Last training status: {status}",
        "training_status_manifest": "Run manifest: {path}",
        "training_status_log": "Training log: {path}",
        "training_status_no_saved_config": "No saved training configuration yet.",
        "training_status_already_running": "Training is already running. PID: {pid}",
        "training_started_background": "Training has started in the background. Project: {project} | Backend: {backend}. You can refresh the UI and use Refresh Training Log to restore the latest logs.",
        # DiffSynth-specific
    ...
    "zh": {
        ...
        "btn_refresh_training_status": "刷新训练日志",
        ...
        "sample_auto_started": "第 {epoch} 轮自动 Sample 已启动：{path}",
        "sample_training_active": "训练仍在运行；Sample 仍可加入队列，但显存不足时可能失败。",
        ...
        "training_status_active": "训练正在当前 UI 进程中运行。PID：{pid}",
        "training_status_thread_active": "训练后台线程正在运行。状态：{status}",
        "training_status_detached": "之前启动的训练进程可能仍在运行。PID：{pid}",
        "training_status_last": "最近一次训练状态：{status}",
        "training_status_manifest": "Run manifest：{path}",
        "training_status_log": "训练日志：{path}",
        "training_status_no_saved_config": "还没有已保存的训练配置。",
        "training_status_already_running": "训练已经在运行中。PID：{pid}",
        "training_started_background": "训练已在后台启动。项目：{project} | 后端：{backend}。刷新 UI 后可通过「刷新训练日志」恢复最新日志。",
        # DiffSynth
