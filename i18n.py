...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "section_sample_queue": "Sample Queue",
        ...
        "btn_refresh_sample_queue": "Refresh Queue",
        "btn_clear_sample_queue": "Clear Finished",
        "btn_retry_failed_sample": "Retry Latest Failed",
        "btn_use_latest_lora": "Use Latest LoRA",
        "btn_refresh_models": "Refresh Models",
        "btn_download_missing_models": "Download Missing Models",
        "btn_refresh_diffsynth_params": "Refresh DiffSynth Parameters",
        ...
        "sample_status_elapsed": "Elapsed",
        "sample_status_output": "Output",
        "sample_status_log": "Log",
        "sample_status_error_tail": "Error log (last lines)",
        "sample_queue_cleared": "Cleared {count} finished sample job(s).",
        "sample_retry_no_failed": "No failed sample job to retry.",
        "sample_retry_started": "Retry started from sample job #{old_id}.",
        ...
        "model_diffsynth_support_skipped": "DiffSynth tokenizer/support download skipped: {path}",
    ...
    "zh": {
        ...
        "section_sample_queue": "Sample 队列",
        ...
        "btn_refresh_sample_queue": "刷新队列",
        "btn_clear_sample_queue": "清理已结束",
        "btn_retry_failed_sample": "重试最近失败",
        "btn_use_latest_lora": "使用最新 LoRA",
        "btn_refresh_models": "刷新模型",
        "btn_download_missing_models": "下载缺失模型",
        "btn_refresh_diffsynth_params": "刷新 DiffSynth 参数",
        ...
        "sample_status_elapsed": "耗时",
        "sample_status_output": "输出",
        "sample_status_log": "日志",
        "sample_status_error_tail": "错误日志（最后几行）",
        "sample_queue_cleared": "已清理 {count} 个已结束的 Sample 任务。",
        "sample_retry_no_failed": "没有可重试的失败 Sample 任务。",
        "sample_retry_started": "已基于 Sample 任务 #{old_id} 发起重试。",
        ...
        "model_diffsynth_support_skipped": "已跳过 DiffSynth tokenizer/support 下载：{path}",
        "outputs_dir": "输出目录",
